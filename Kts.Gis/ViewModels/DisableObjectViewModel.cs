...
{
    internal sealed class DisableObjectViewModel : BaseViewModel
    {
        ...
        public DisableObjectViewModel(IMapBindingService mapBindingService, ISettingService settingService)
        {
            this.mapBindingService = mapBindingService;
            this.settingService = settingService;

            // Получаем кисть.
            var brush = new SolidColorBrush((System.Windows.Media.Color)ColorConverter.ConvertFromString(settingService.Settings["UOColor"].ToString()));
            if (brush.CanFreeze)
                brush.Freeze();
