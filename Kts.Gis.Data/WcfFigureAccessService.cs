...
namespace Kts.Gis.Data
{
    public class WcfFigureAccessService : BaseWcfDataAccessService, IFigureAccessService
    {
        ...
        List<Tuple<string, string>> IFigureAccessService.GetJurObjects(SchemaModel schema, int cityId)
        {
            throw new NotImplementedException();
        }

        List<Tuple<string, string>> IFigureAccessService.GetKvpObjects(SchemaModel schema, int cityId)
        {
            throw new NotImplementedException();
        }
    }
