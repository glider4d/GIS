...
namespace Kts.Gis.ViewModels
{
    ...
    public sealed class AuthorizationViewModel : BaseViewModel
    {
        ...
        public AuthorizationViewModel(WcfDataService wcfDataService, /*Dictionary<SqlConnectionString, string> serverData, */IMessageService messageService, Page mainPage)
        {
            m_mainPage = mainPage;
        ...
        public SqlConnectionString SelectedServer
        {
            ...
            set
            {
                ...
                if (this.SelectedServer != null && this.selectedServer.Server != "-1" && !breakeFlag)
                {
        ...
        private void ExecuteCheckPassword()
        {
            ...
            //if (true)
            {
                ...
                m_mainPage.DisplayAlert("Уведомление", "Авторизация прошла успешно", "ОK");
                //m_mainPage.cl

                if (m_mainPage is testXamarin.Views.AutorizationView)
                {
                    (m_mainPage as testXamarin.Views.AutorizationView).clickButton();
                }
            ...
            {
                m_mainPage.DisplayAlert("Авторизация", "Неверный пароль", "ОK");
                for (int i = 0; i < 10; i++)
                {
