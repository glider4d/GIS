...
{
    /// <summary>
    /// Представляет модель представления ожидания окончания выполнения какой-либо задачи.
    /// </summary>
    public sealed class WaitViewModel
    {
        ...
        public WaitViewModel(string title, string content, Func<Task> action)
        {
            this.Title = title;
        ...
        public WaitViewModel(string title, string content, Func<Task<bool>> func)
        {
            this.Title = title;
            this.Content = content;
            this.Func = func;
