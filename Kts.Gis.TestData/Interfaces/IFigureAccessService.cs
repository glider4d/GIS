...
namespace Kts.Gis.Data
{
    ...
    public interface IFigureAccessService : IDeletableObjectAccessService<FigureModel>, IModifiableObjectAccessService<FigureModel>, IObjectAccessService<FigureModel>
    {
        ...
        List<Tuple<long, string>> GetJurObjects(SchemaModel schema, int cityId);
        ...
        /// <param name="cityId">Идентификатор населенного пункта.</param>
        /// <returns>Список объектов.</returns>
        List<Tuple<long, string>> GetKvpObjects(SchemaModel schema, int cityId);
        ...
        /// <param name="schema">Схема.</param>
        void SetJurId(Guid gisId, long jurId, SchemaModel schema);
        ...
        /// <param name="schema">Схема.</param>
        void SetKvpId(Guid gisId, int kvpId, SchemaModel schema);
