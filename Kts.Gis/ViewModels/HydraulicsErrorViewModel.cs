...
{
    /// <summary>
    /// Представляет модель представления слоя ошибок гидравлики.
    /// </summary>
    internal sealed class HydraulicsErrorViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// Инициализирует новый экземпляр класса <see cref="HydraulicsErrorViewModel"/>.
        /// </summary>
        /// <param name="mapBindingService">Сервис привязки представлений карты с моделями представлений.</param>
        public HydraulicsErrorViewModel(IMapBindingService mapBindingService)
        {
        ...
        /// <summary>
        /// Инициализирует статические члены класса <see cref="HydraulicsErrorViewModel"/>.
        /// </summary>
        static HydraulicsErrorViewModel()
        {
