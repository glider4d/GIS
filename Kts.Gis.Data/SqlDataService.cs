...
namespace Kts.Gis.Data
{
    ...
    public sealed partial class SqlDataService
    {
        ...
        public IBuilderInfoAccessService BuilderInfoAccessService
        {
            get;
            private set;
        }
...
#warning Прямое использование идентификатора типа объекта
        ...
        public async Task LoadDataAsync(int loggedUserID = 0)
        {
            if (loggedUserID != 0) this.LoggedUserId = loggedUserID; 
            await Task.Factory.StartNew(() =>
            {
                ...
                this.ReportAccessService = new SqlReportAccessService(this.connector, this.LoggedUserId);
                ...
                this.BuilderInfoAccessService = new SqlBuilderInfoAccessService(this, this.connector, this.LoggedUserId);
