...
{
    /// <summary>
    /// Представляет модель представления прямоугольника.
    /// </summary>
    [Serializable]
    internal sealed partial class RectangleViewModel : FigureViewModel
    {
        #region Конструкторы

        /// <summary>
        /// Инициализирует новый экземпляр класса <see cref="RectangleViewModel"/>.
        /// </summary>
        ...
        public RectangleViewModel(FigureModel rectangle, ILayerHolder layerHolder, AccessService accessService, IDataService dataService, HistoryService historyService, IMapBindingService mapBindingService, IMessageService messageService) : base(rectangle, layerHolder, accessService, dataService, historyService, mapBindingService, messageService)
        {
    ...
    internal sealed partial class RectangleViewModel
    {
        ...
        public override string Points
        {
            ...
            set
            {
                throw new NotImplementedException("Не реализована возможность задания последовательности точек прямоугольнику");
            }
        }
        ...
        public override ICopyableObjectViewModel Copy()
        {
            ...
            var viewModel = new RectangleViewModel(model, this.layerHolder, this.AccessService, this.DataService, this.HistoryService, this.MapBindingService, this.MessageService);
